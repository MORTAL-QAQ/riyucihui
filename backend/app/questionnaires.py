...
Q1_BLOCKS_EXP = Q1_BLOCKS_COMMON
Q1_BLOCKS_CTRL = [
    {
        "title": "自主性",
        "rows": [
            "在《多模态日语词汇学习网站》中，我可以按照自己喜欢的方式安排词汇学习",
            "我能自由决定先学什么、后学什么（如选择主题、新词或复习）",
            "我的学习节奏是由我自己掌控的",
            "在《多模态日语词汇学习网站》中，我有机会表达自己的意见和想法",
            "我觉得自己被要求按照固定的方式学习，没有选择的余地",
            "很多时候我感到自己不得不学习，而不是自愿学习",
        ],
    },
        ...
        "pages": [
            ...
            {"title": "近期学习感受（一）", "items": [
                _m_blocks("p2m1", "请回想你近两周日语词汇学习的情况，评价下列描述与你的符合程度。",
                          Q1_BLOCKS_COMMON, AGREE5, Q1_REVERSE_ROWS),
            ]},
            {"title": "学习情绪", "items": [
    ...
    "pages": [
        ...
        {"title": "开放题（选填）", "items": [
            {"key": "p6q1", "type": "textarea", "required": False,
             "text": "使用《多模态日语词汇学习网站》学习词汇，你最大的收获是什么？",
             "placeholder": "选填，可留空"},
            {"key": "p6q2", "type": "textarea", "required": False,
             "text": "《多模态日语词汇学习网站》最需要改进的地方是什么？",
             "placeholder": "选填，可留空"},
        ]},
    ],
    "dimensions": {
