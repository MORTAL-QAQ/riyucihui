...
- `2026-09.2`：**卷4 同样取消分组，合并为单一版本**（`q4`）——同一被试内逻辑；
  采用含「图片/语音」的那版行标签（外在负荷、相关负荷），原 `q4_ctrl` 已废弃。
  卷3/卷1 的「实验组」分组字样暂按原状保留（如需一并清理请说明）。
"""
...
# 2026-09.2 起卷4 合并为单一版本，采用含多模态材料的那版措辞
# （外在负荷与相关负荷两行保留「图片/语音」，因为现在人人都会接触多模态材料）
_Q4_ROWS = [
...
QUESTIONNAIRES.append({
    ...
    "pages": [
        ...
        {"title": "负荷感受", "items": [
            _m("p2m1", "请评价以下说法……", _Q4_ROWS, AGREE5),
        ]},
    ],
    "dimensions": {
        "Q11_整体难度": ["p1q1"],
