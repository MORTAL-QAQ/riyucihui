...
from .routers import achievement, admin_api, auth, checkin, cloze, community, essay, experiment, export, generate, grammar, questionnaire, settings, study, voice, words
